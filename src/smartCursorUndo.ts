 ...
 *     6. No document edit in diff1 (same version number), but edit in diff2 (different version number).
 *     7. Document edit in diff1 (different version number), but no edit in diff2 (same version number).
 */
